...
| B0. v001b | **9/26 21:00** | 사용자 요청(request 366ca1e1): v001에서 S2 collision·entry만 정렬 프레임 목록의 인덱스 30·22로 교체한다. 학습 없이 추론만 바꾸고, 나머지 출력은 v001과 동일하게 둔다. 검증 후 `submission_candidate` 보고, 사용자가 오늘 자정 전에 업로드한다. v002보다 먼저 한다 |
