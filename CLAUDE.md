...
10. **v001 리더보드 결과와 공식 채점식(9/26 17:20 승인).** submit001(v001, 세 Stage 모두 e001) 결과: S1 0.5650, S2 0.2060, S3 0.4656, 종합 약 0.382, 실행 15분 29초(한도 60분).
   ...
   - **S2(개선 여지가 가장 큼):** 시점 헤드는 ±0.3초 적중률을 최대화하도록 바꾼다(예: 프레임 분류나 heatmap 후 argmax). 공식 형식 창(10Hz·50프레임)에서 적중률이 가장 높은 상수 시점과 비교해, 더 나은 쪽을 제출한다. 방향·회피 예측은 한 클래스로 몰리지 않게 한다.
