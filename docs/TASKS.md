...
| H2 | Ultra | 공개 GitHub origin 연결·README·코드 게시 | H0 | jinw00ch01/Dacon_AFDA_Challenge |
...
| L0 | Ultra | QEMU CPU Linux 계약 검증 및 CUDA 컨테이너 준비 | H0 | environment/README.md 및 로컬 실행 로그 |
