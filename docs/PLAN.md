...
- 사용자 지시에 따라 공개 저장소 jinw00ch01/Dacon_AFDA_Challenge를 origin에 연결하고 코드·README를 게시했다.
- Pro는 PRO360_STEPS.md에 따라 기존 폴더를 보존하고 새 형제 폴더로 clone한다. 데이터는 공개 Git에 올리지 않는다.
